...
See the [setup guide](https://frameshift.pub/guide/#options) to change retention,
keep separate screenshot sets, comment on matching screenshots, or use the
lower-level storage Actions.
